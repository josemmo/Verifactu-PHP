        ...
        foreach ($records as $record) {
            ...
            foreach ($record->breakdown as $breakdownDetails) {
                ...
                if(!empty($breakdownDetails->exemptReasonCode)){
                    ...
                    if ($breakdownDetails->surchargeRate !== null && $breakdownDetails->surchargeAmount !== null) {
